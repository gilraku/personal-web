import { ExternalLink, Shield, Crosshair, Lightbulb } from "lucide-react";
          ...
          {projects.map((project, index) => {
            ...
            return (
              <ScrollReveal key={project.title} delay={100 + index * 100}>
                <Card className={`bg-card/50 border-border overflow-hidden group transition-all duration-300 ${styles.hover} h-full`}>
